...
export const NOTIFICATION_PRIORITY = {
  comunicacion: ['assigned', 'overdue', 'soon', 'month_close', 'missing_post', 'world_day', 'competition_review', 'new', 'responsible'],
  marketing: ['assigned', 'overdue', 'soon', 'month_close', 'missing_post', 'world_day', 'competition_review', 'responsible', 'new'],
};
