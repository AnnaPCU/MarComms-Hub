...
export const makeWebinar = (name, date, client, monto, pais, unidadNegocio) => {
  let w = {
    ...
    lknAnuncio:       { done: false, date: '', owner: 'Agustina Ball' },
    lknReminder:      { done: false, date: '', owner: 'Agustina Ball' },
    lknHoy:           { done: false, date: '', owner: 'Agustina Ball' },
    lknPost:          { done: false, date: '', owner: 'Agustina Ball' },
